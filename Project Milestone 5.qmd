...
Graph_2 <- ggplot(data_long_pct, aes(x = race_eth, y = value, fill = metric)) +
  ...
  labs(
    title = "California Novel Respiratory Disease Infections \nby Race/Ethnicity, 2023",
    x = "Race Category",
...
race_kable <- kable(
  ...
  digits = 1,
  align = c('l', 'c', 'c', 'c'),
  caption = "California Novel Respiratory Disease Incidence Rates (per 100 people) by Race/Ethnicity, 2023"
) %>%
